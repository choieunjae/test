  ...
  <div id="wrap">
	...
	<class="product"><a href="admin_product.jsp">상품 등록하기 (관리자)</a>
      ...
      <p class="backpack_name">백팩 </p>
          ...
          <ul class="sub_nav">
			    <li><a href='product_list.jsp?cat2=1'>가죽</a></li>
			    <li>/</li>
  				<li><a href='product_list.jsp?cat2=2'>캐쥬얼</a></li>
			</ul>
      </header>
      <section>
<div id="section1">
...
<ul class="re_product">
<li><a href="product_read.jsp?id=120005&go=1&cat=&pname="><div class="img-box"><img src="images/back_product_8.jpg"></div><div class="text-box"><span class="name">[르버앤코] SURFING MESH BACKPACK WHITE 백팩<span><br/><br/><span class="price">38,000원</span></div></a></li>
<li><a href="product_read.jsp?id=120004&go=1&cat=&pname="><div class="img-box"><img src="images/back_product_9.jpg"></div><div class="text-box"><span class="name">[디랩] Collaboration 275c X BAGPACK</span><br/><br/><br/><span class="price">18,000원</span></div></a></li>
<li><a href="product_read.jsp?id=120006&go=1&cat=&pname="><div class="img-box"><img src="images/back_product_11.jpg"></div><div class="text-box"><span class="name">[퍼시] 뉴 베른 캔버스 데이 백팩 그레이</span><br/><br/><br/><span class="price">35,000원</span></div></a></li>
<li><a href="product_read.jsp?id=120007&go=1&cat=&pname="><div class="img-box"><img src="images/back_product_13.jpg"></div><div class="text-box"><span class="name">[칼하트] 레거시 스탠다드 백팩</span><br/><br/><br/><span class="price">48,000원</span></div></a></li>
<li><a href="product_read.jsp?id=120001&go=1&cat=&pname="><div class="img-box"><img src="images/back_product_5.jpg"></div><div class="text-box"><span class="name">[annavono] 폴리 백팩</span><br/><br/><br/><span class="price">34,000원</span></div></a></li>
</ul>
</div>
<div id="section2">
