  ...
  <div id="wrap">
	...
	<class="product"><a href="admin_product.jsp">상품 등록하기 (관리자)</a>
      ...
      <p class="backpack_name">백팩 </p>
          ...
          <ul class="sub_nav">
			    <li><a href='product_list.jsp?cat2=6'>가죽</a></li>
			    <li>/</li>
  				<li><a href='product_list.jsp?cat2=7'>캐쥬얼</a></li>
			</ul>
      </header>
      <section>
<div id="section1">
...
<ul class="re_product">
<li><a href="product_read.jsp?id=470001&go=1&cat=&pname="><div class="img-box"><img src="images/clutch_product_4.jpg"></div><div class="text-box"><span class="name">[마스마룰즈] mini pocket cross bag</span><br/><br/><br/><span class="price">29,900원</span></div></a></li>
<li><a href="product_read.jsp?id=480005&go=1&cat=&pname="><div class="img-box"><img src="images/clutch_product_9.jpg"></div><div class="text-box"><span class="name">[로터프] LO-6126 NV 브랜드클러치</span><br/><br/><br/><span class="price">65,000원</span></div></a></li>
<li><a href="product_read.jsp?id=470004&go=1&cat=&pname="><div class="img-box"><img src="images/clutch_product_1.jpg"></div><div class="text-box"><span class="name">[인케이스] Incase Classic Universal Sleeve for 13</span><br/><br/><span class="price">30,000원</span></div></a></li>
<li><a href="product_read.jsp?id=470002&go=1&cat=&pname="><div class="img-box"><img src="images/clutch_product_2.jpg"></div><div class="text-box"><span class="name">[탐탁] 아이패드프로 3세대 하드케이스</span><br/><br/><br/><span class="price">15,000원</span></div></a></li>
<li><a href="product_read.jsp?id=470003&go=1&cat=&pname="><div class="img-box"><img src="images/clutch_product_5.jpg"></div><div class="text-box"><span class="name">[인케이스] INCASE - Slip Folio Select MB 13</span><br/><br/><span class="price">47,000원</span></div></a></li>
</ul>
</div>
<div id="section2">
...
if (request.getParameter("cat1") != null) {
 ...
 try {
  ...
  sql = sql+" where category=4 order by id;";
 ...
 if (wheregroup > 1) {
  ...
  out.print("[<A href=\"clutchwallet.jsp?gogroup=1"); 
  out.print("&pname="+pn+"\">처음</A>]");
  out.print("[<A href=\"clutchwallet.jsp?gogroup="+priorgroup);
 ...
 if (totalrows !=0) {  
  for(int jj=startpage; jj<=endpage; jj++) {
   if (jj==where) 
    ...
    out.print("[<A href=\"clutchwallet.jsp?go="+jj) ;
    out.print("&pname="+pn+"\">"+jj + "</A>]") ;
   }
  } 
 }
 if (wheregroup < totalgroup) {
  out.print("[<A href=\"clutchwallet.jsp?gogroup="+ nextgroup);
  out.print("&pname="+pn+"\">다음</A>]");
  out.print("[<A href=\"clutchwallet.jsp?gogroup="+ totalgroup);
