...
<P>                                           
<FORM name="msgwrite" method="post" action="qna_save.jsp">    
<CENTER>                                      
<table   class='qna_read' width="80%"cellspacing="0" cellpadding="2">           
 ...
 <tr>                                        
  <td colspan="2"  height="50" class="notice">&nbsp;&nbsp;<font size="4">고객 문의 게시판</font></td> 
 </tr>                                       
 <tr>                                       
  <td colspan="2" bgcolor="#e8f0ff" height="1"></td>   
 </tr>                                     
 <tr>                                        
  <td width="10%" height="30" align="center" bgcolor="#e6eeff" style="border-right:1px solid #e8f0ff; border-left:1px solid #e8f0ff"><font size="2">이름</font></td>   
  <td width="80%"   style="padding:0 0 0 10 ;border-right:1px solid #e8f0ff"  align="left"><input type=text name=name class="input_style1"></td>      
 </tr>                                      
 <tr>                                         
  <td width="10%" align="center"  bgcolor="#e6eeff" style="border-right:1px solid #e8f0ff; border-left:1px solid #e8f0ff"><font size="2">E-mail</font></td>  
  <td width="80%" style="padding:0 0 0 10 ;border-right:1px solid #e8f0ff" height="25"  align="left"><input type=text name=email class="input_style1"></td>               
 </tr>                                       
 <tr>                                        
  <td width="10%" align="center"  bgcolor="#e6eeff" style="border-right:1px solid #e8f0ff; border-left:1px solid #e8f0ff" ><font size="2">제 목</font></td>   
  <td width="80%" style="padding:0 0 0 10 ;border-right:1px solid #e8f0ff" height="25"  align="left" ><input type=text name=subject size="60" maxlength="60" class="input_style2"></td>                                      
 </tr>                                        
 <tr>                             
  <td width="10%" height="162" align="center" valign="top" bgcolor="#e6eeff" style="padding-top:7px;border-right:1px solid #e8f0ff; border-left:1px solid #e8f0ff" ><font size="2">내 용</font></td>
  <td width="80%" valign="top"  style="padding:5 0 5 10 ;border-right:1px solid #e8f0ff ;"  align="left">    
   <textarea cols="136" rows="30" name=content maxlength="2000" class="textarea_style1"></textarea>     
  </td>                                     
 </tr>                                        
 <tr>                                        
  <td width="10%" align="center"  bgcolor="#e6eeff" style="border-right:1px solid #e8f0ff ; border-left:1px solid #e8f0ff"><font size="2">암 호</font></td>  
  <td width="80%" style="padding:0 0 0 10;border-right:1px solid #e8f0ff ;" height="25"  align="left">                   
   <input type=password name=password class="style1"><br><font size="2">(비밀번호를 입력시 등록 후 수정 또는 삭제가 가능합니다.)</font>
  </td>                                       
 </tr>                                       
 <tr>                                       
  ...
  <td colspan="2" align="right">                    
   <table width="100%" border="0" cellpadding="0" cellspacing="0">                      
    <tr>                     
     <td width="28%">&nbsp;</td>               
     <td width="51%">&nbsp;</td>                
     <td width="5%"><a href="#" onClick="history.back();"><img src="images/cancel.png" width="46" height="20" border="0"></td>
