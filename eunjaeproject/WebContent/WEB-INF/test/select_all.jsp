...
<table width="80%;" cellpadding="3" cellspacing="0" align="center" >
  ...
  <TH height='30px'  colspan='3'>회원 목록</TH>
    <tr align="center"> 
   <td colspan="5" bgcolor="#e8f0ff" height="1"></td>
  </tr>
 <TH bgcolor=#e8f0ff height='30px'>사용자 ID</TH>
 <TH bgcolor=#e8f0ff height='30px'>이 름</TH>
 <TH bgcolor=#e8f0ff height='30px'>주 소</TH>
 <% if (!(rs.next()))  {%>
 <TR><TD colspan=4>등록된 회원이 없습니다.</TD></TR>
 <%  } else {
   do {
    out.println("<TR>");
    out.println("<TD align='center' height='40px'>" + rs.getString("userid") + "</TD>");
    out.println("<TD align='center' height='40px'>" + rs.getString("username") + "</TD>");
    out.println("<TD height='40px'> " + rs.getString("address1"));
