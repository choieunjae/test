...
<body>
  <div id="wrap">
	...
	<class="product"><a href="admin_product.jsp">상품 등록하기 (관리자)</a>
      ...
      <p class="backpack_name">백팩 </p>
          
          <ul class="sub_nav">
			    <li><a href='product_list.jsp?cat2=3'>가죽</a></li>
			    <li>/</li>
  				<li><a href='product_list.jsp?cat2=4'>캐쥬얼</a></li>
			</ul>
      </header>
      <section>
<div id="section1">
...
<ul class="re_product">
<li><a href="product_read.jsp?id=230001&go=1&cat=&pname="><div class="img-box"><img src="images/cross_product_4.jpg"></div><div class="text-box"><span class="name">플레인 숄더 크로스백</span><br/><br/><br/><span class="price">30,000원</span></div></a></li>
<li><a href="product_read.jsp?id=240004&go=1&cat=&pname="><div class="img-box"><img src="images/cross_product_2.jpg"></div><div class="text-box"><span class="name">메모리얼 토트 크로스백</span><br/><br/><br/><span class="price">32,000원</span></div></a></li>
<li><a href="product_read.jsp?id=240001&go=1&cat=&pname="><div class="img-box"><img src="images/cross_product_5.jpg"></div><div class="text-box"><span class="name">지퍼 포켓 크로스백</span><br/><br/><br/><span class="price">15,000원</span></div></a></li>
<li><a href="product_read.jsp?id=230003&go=1&cat=&pname="><div class="img-box"><img src="images/cross_product_10.jpg"></div><div class="text-box"><span class="name">코코백-라이트그레이</span><br/><br/><br/><span class="price">41,000원</span></div></a></li>
<li><a href="product_read.jsp?id=240002&go=1&cat=&pname="><div class="img-box"><img src="images/cross_product_12.jpg"></div><div class="text-box"><span class="name">파세오 베이직 토트</span><br/><br/><br/><span class="price">25,000원</span></div></a></li>
</ul>
</div>
<div id="section2">
...
if (request.getParameter("cat1") != null) {
 ...
 try {
  ...
  sql = sql+" where category=2 order by id;";
 ...
 if (wheregroup > 1) {
  ...
  out.print("[<A href=\"crossbag.jsp?gogroup=1"); 
  out.print("&pname="+pn+"\">처음</A>]");
  out.print("[<A href=\"crossbag.jsp?gogroup="+priorgroup);
 ...
 if (totalrows !=0) {  
  for(int jj=startpage; jj<=endpage; jj++) {
   if (jj==where) 
    ...
    out.print("[<A href=\"crossbag.jsp?go="+jj) ;
    out.print("&pname="+pn+"\">"+jj + "</A>]") ;
   }
  } 
 }
 if (wheregroup < totalgroup) {
  out.print("[<A href=\"crossbag.jsp?gogroup="+ nextgroup);
  out.print("&pname="+pn+"\">다음</A>]");
  out.print("[<A href=\"crossbag.jsp?gogroup="+ totalgroup);
...
<span class="name">홈페이지 대표 :최은재</span>
<span class="tel">연락처 : 032-770-8114<br></span>
<span class="addr">인천광역시 남구 숙골로 113</span>
</footer>
</div>
</div>
</body>
