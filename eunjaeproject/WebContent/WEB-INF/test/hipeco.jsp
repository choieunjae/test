  ...
  <div id="wrap">
	...
	<class="product"><a href="admin_product.jsp">상품 등록하기 (관리자)</a>
      ...
      <p class="backpack_name">백팩 </p>
          ...
          <ul class="sub_nav">
			    <li><a href='product_list.jsp?cat2=4'>가죽</a></li>
			    <li>/</li>
  				<li><a href='product_list.jsp?cat2=5'>캐쥬얼</a></li>
			</ul>
      </header>
      <section>
<div id="section1">
...
<ul class="re_product">
<li><a href="product_read.jsp?id=360002&go=1&cat=&pname="><div class="img-box"><img src="images/eco_product_1.jpg"></div><div class="text-box"><span class="name">[슈탠다드] 핸드폰 에코백</span><br/><br/><br/><span class="price">10,000원</span></div></a></li>
<li><a href="product_read.jsp?id=350005&go=1&cat=&pname="><div class="img-box"><img src="images/hip_product_5.jpg"></div><div class="text-box"><span class="name">[제너] 힙색 웨이스트백</span><br/><br/><br/><span class="price">36,000원</span></div></a></li>
<li><a href="product_read.jsp?id=350002&go=1&cat=&pname="><div class="img-box"><img src="images/hip_product_4.jpg"></div><div class="text-box"><span class="name">[피스메이커]CORDURA TECH SLING BAG (ALL BLACK) 슬링백</span><br/><br/><span class="price">49,900원</span></div></a></li>
<li><a href="product_read.jsp?id=360004&go=1&cat=&pname="><div class="img-box"><img src="images/eco_product_6.jpg"></div><div class="text-box"><span class="name">[네이키드니스] CANVAS POCKET BAG</span><br/><br/><br/><span class="price">21,000원</span></div></a></li>
<li><a href="product_read.jsp?id=360003&go=1&cat=&pname="><div class="img-box"><img src="images/eco_product_9.jpg"></div><div class="text-box"><span class="name">[스탐]STAM 캔버스 디링 미니 로고 자수 에코백</span><br/><br/><span class="price">15,000원</span></div></a></li>
</ul>
</div>
<div id="section2">
...
if (request.getParameter("cat1") != null) {
 ...
 try {
  ...
  sql = sql+" where category=3 order by id;";
 ...
 if (wheregroup > 1) {
  ...
  out.print("[<A href=\"hipeco.jsp?gogroup=1"); 
  out.print("&pname="+pn+"\">처음</A>]");
  out.print("[<A href=\"hipeco.jsp?gogroup="+priorgroup);
 ...
 if (totalrows !=0) {  
  for(int jj=startpage; jj<=endpage; jj++) {
   if (jj==where) 
    ...
    out.print("[<A href=\"hipeco.jsp?go="+jj) ;
    out.print("&pname="+pn+"\">"+jj + "</A>]") ;
   }
  } 
 }
 if (wheregroup < totalgroup) {
  out.print("[<A href=\"hipeco.jsp?gogroup="+ nextgroup);
  out.print("&pname="+pn+"\">다음</A>]");
  out.print("[<A href=\"hipeco.jsp?gogroup="+ totalgroup);
