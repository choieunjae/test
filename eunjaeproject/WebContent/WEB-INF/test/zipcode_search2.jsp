...
<script language="javascript">
 ...
 function choiceZipcode(zipcodeno, address1){
  opener.document.order.zipcode_1.value = zipcodeno.substring(0,3);
  opener.document.order.zipcode_2.value = zipcodeno.substring(4,7);
  opener.document.order.address_1.value = address1;
  opener.document.order.address_2.focus()
  self.close();
}
...
<form name="zipcode2" method="post" action="zipcode_search2.jsp">
...
%>
 <table align="center" width="95%" border="0" cellspacing="0" cellpadding="3" bordercolor="#999999" class="style2">
  <tr align="center"> 
   <td width="27%" bgcolor="#b5cdff"><font color="#FFFFFF">우편번호</font></td>
   <td width="73%" bgcolor="#e8f0ff"><font color="#999999">주소</font></td>
  </tr>
 </table>
