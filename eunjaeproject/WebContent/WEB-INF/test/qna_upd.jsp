...
<FORM name="msgwrite" method=POST action="qna_upddb.jsp?id=<%=id%>&page=<%=p%>">
 <table  class='qna_read' width="80%" cellspacing="0" cellpadding="2">
  ...
  <tr> 
   <td colspan="2"  height="50" class="notice">&nbsp;&nbsp;<font size="4">글 수정하기</font></td>
  </tr>
  <tr> 
   <td colspan="2" bgcolor="#e8f0ff" height="1"></td>
  </tr>
  <tr> 
   ...
   <td width="80%"   style="padding:0 0 0 10 ;border-right:1px solid #e8f0ff"  align="left"> 
  ...
  <tr> 
   ...
   <td width="80%" valign="top"  style="padding:5 0 5 10 ;border-right:1px solid #e8f0ff ;"  align="left"> 
    <textarea name=content  cols="136" rows="30"class="textarea_style1"><%=rs.getString("content")%> </textarea>
   </td>
  </tr>
  <tr> 
   <td width="10%" align="center" bgcolor="#e6eeff" style="border-right:1px solid #e8f0ff ; border-left:1px solid #e8f0ff">암 호</td>
   <td width="80%"style="padding:0 0 0 10;border-right:1px solid #e8f0ff ;" height="25"  align="left"> 
    <input type='password' name='password'  class="input_style1"><br><font size="2">(정확한 비밀번호를 입력해야만 수정이 됩니다.)</font>
   </td>
  </tr>
  <tr> 
   ...
   <td colspan="2" align="right"> 
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
     <tr> 
      ...
      <td width="1%"><a href="#" onClick="history.go(-1)"><img src="images/cancel.png"  border="0"></td>
