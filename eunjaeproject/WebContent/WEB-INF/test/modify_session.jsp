...
<div align="center">
 <form name="join" method="post" action="modify_session.jsp">
  <table width="80%" height="536" cellspacing="0" cellpadding="0" >
   <tr> 
  <td colspan="2" bgcolor="#e8f0ff" height="4"></td>
  </tr>
   <tr> 
    <td width="15%"  height="30" align="center" bgcolor="#e6eeff" style="border-right:1px solid #e8f0ff; border-left:1px solid #e8f0ff;padding:0 0 0 14"> <font class="style2">아이디&nbsp;&nbsp;</font><font color="#FF0000" size=1>*</font></td>
    <td width="75%">&nbsp;
     <input type="text" name="userid" size="10" maxlength="10" class="box" value="<%=userid%>" readonly></font></font></td>
   </tr>
   <tr> 
    <td width="15%" height="30" align="center" bgcolor="#e6eeff" style="border-right:1px solid #e8f0ff; border-left:1px solid #e8f0ff;padding:0 0 0 14" ><font class="style2">비밀번호&nbsp;&nbsp;</font><font color="#FF0000" size=1>*</font></td>
    <td width="75%">&nbsp; 
   ...
   <tr > 
    <td width="15%" height="30" align="center" bgcolor="#e6eeff" style="border-right:1px solid #e8f0ff; border-left:1px solid #e8f0ff;padding:0 0 0 14"><font class="style2" >이름&nbsp;&nbsp;</font><font color="#FF0000" size=1>*</font></td>
    <td width="75%">&nbsp; 
     <input type="text" name="username" size="10" maxlength="10" class="box" value="<%=username%>"></td>
   </tr>
   <tr > 
    <td width="15%"  height="30" align="center" bgcolor="#e6eeff" style="border-right:1px solid #e8f0ff; border-left:1px solid #e8f0ff;padding:0 0 0 14"><font class="style2">E-MAIL&nbsp;&nbsp;</font><font color="#FF0000" size=1>*</font></td>
    <td width="75%">&nbsp;
     <input type="text" name="email" size="20" maxlength="50" class="box" value="<%=email%>"></td>
   </tr>
   <tr > 
    <td width="15%"  height="30" align="center" bgcolor="#e6eeff" style="border-right:1px solid #e8f0ff; border-left:1px solid #e8f0ff;padding:0 0 0 14"><font class="style2">우편번호&nbsp;&nbsp;</font><font color="#FF0000" size=1>*</font></td>
    <td width="75%">&nbsp; 
   ...
   <tr > 
    <td width="15%"  height="30" align="center" bgcolor="#e6eeff" style="border-right:1px solid #e8f0ff; border-left:1px solid #e8f0ff;padding:0 0 0 14"><font class="style2">주소&nbsp;&nbsp;</font><font color="#FF0000" size=1>*</font></td>
    <td width="75%">&nbsp; 
     <input type="text" name="address1" size="50" maxlength="100" class="box" readonly value="<%=address1%>"></td>
   </tr>
   <tr > 
    <td width="15%"  height="30" align="center" bgcolor="#e6eeff" style="border-right:1px solid #e8f0ff; border-left:1px solid #e8f0ff;padding:0 0 0 14"><font class="style2" >나머지 주소&nbsp;&nbsp;</font><font color="#FF0000" size=1>*</font></td>
    <td width="75%">&nbsp; 
     <input type="text" name="address2" size="50" maxlength="100" class="box" value="<%=address2%>"></td>
   </tr>
   <tr > 
    <td width="15%"  height="30" align="center" bgcolor="#e6eeff" style="border-right:1px solid #e8f0ff; border-left:1px solid #e8f0ff;padding:0 0 0 14"><font class="style2">휴대폰&nbsp;&nbsp;</font></td>
    <td width="75%">&nbsp; 
    ...
    <tr> 
  <td colspan="2" bgcolor="#e8f0ff" height="5"></td>
 </tr>
  </table>
 <br/>
  <table width="614" border="0" cellspacing="0" cellpadding="0" align="center" >
   <tr>
    <td width=100% align="center"> 
     ...
     <input type="button" value=" " class='upload'  onClick="doSubmit()">&nbsp;
     <input type="button" value=" " class='cancel' onClick="javascript:history.go(-1);">
    </td>
   </tr>
  </table>
 </form>
