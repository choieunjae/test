...
<CENTER> 
<FORM name="msgdel" method=post action=photo_deldb.jsp>
 ...
 <table width="80%" cellspacing="0" cellpadding="2">         
  ...
  <tr>                                                               
   <td colspan="2"  height="50" class="notice"><b><font size="4">리뷰 삭제하기</font></b></td>                                                                  
  </tr>                                                             
  <tr>                                                              
   <td colspan="2" bgcolor="#e8f0ff" height="1"></td>             
  </tr>                                                            
  <tr>                                                               
   <td width="10%" height="30" bgcolor="#e6eeff" style="border-right:1px solid #e8f0ff; border-left:1px solid #e8f0ff" >비밀번호</td>  
  ...
  <tr>                                                              
   <td colspan="2" align="right">                                     
    <table width="100%" border="0" cellpadding="4" cellspacing="4">        
     <tr>                                                          
      <td width="84%">&nbsp;</td>                                             
      <td width="1%"><a href="photo_list.jsp "><img src="images/list.png" width="48" height="19" border="0"></a></td>
