 ...
 if (cont.length()==1) 
  ...
  try {
   ...
   if (pwd.equals(request.getParameter("password"))) {
    ...
    if (cnt >0){ 
    	  out.println("<div class='baguni_header' style='width:30%; margin:auto; text-align:center;'>고객게시판</div><div class='baguni_content'style='width:30%; height:250px; margin:auto; text-align:center;'><img src='images/upl_ok.png' width=300 height=300><p style='margin:auto'></div><div class='baguni_footer'style='width:80%; margin:auto;text-align:center;'></div>");
    }else{
      	out.println("<div class='baguni_header' style='width:30%; margin:auto; text-align:center;'>고객게시판</div>");
